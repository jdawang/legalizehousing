	...
	if (data.hasOwnProperty('representatives_centroid')) {
		...
		for (let i = 0; i < data.representatives_centroid.length; i++) {
			...
			content = content +
						...
						'<h5><a id="gmail_text_' + data.representatives_centroid[i].name + '" href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=' + data.representatives_centroid[i].email + "; minister.mah@ontario.ca; jbell-co@ndp.on.ca; sblais.mpp.co@liberal.ola.org; mschreiner-co@ola.org" + '&bcc=volunteer@moreneighbours.ca' + '&su=' + EMAIL_SUBJECT + '&body=' + EMAIL_BODY + '" class="email-header" target="_blank">Gmail</a></h5>' +
						'<a id="gmail_icon_' + data.representatives_centroid[i].name + '" href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=' + data.representatives_centroid[i].email + "; minister.mah@ontario.ca; jbell-co@ndp.on.ca; sblais.mpp.co@liberal.ola.org; mschreiner-co@ola.org" + '&bcc=volunteer@moreneighbours.ca' + '&su=' + EMAIL_SUBJECT + '&body=' + EMAIL_BODY + '" target="_blank"><img src="assets/img/Gmail-Email.png" class="icon" alt="assets/img/No-Image.png"></a>' +
						'</div>' +
						'<div class="col-xs-2 col-xs-offset-1 justify-content-center text-center">' +
						'<h5><a id="outlook_text_' + data.representatives_centroid[i].name + '" href="https://outlook.office.com/mail/0/deeplink/compose?popoutv2=1&subject=' + EMAIL_SUBJECT + '&body=' + EMAIL_BODY + '&to=' + data.representatives_centroid[i].email + ", minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + '&bcc=volunteer@moreneighbours.ca' + '&path=%2fmail%2faction%2fcompose" class="email-header" target="_blank">Outlook</a></h5>' +
						'<a id="outlook_icon_' + data.representatives_centroid[i].name + '" href="https://outlook.office.com/mail/0/deeplink/compose?popoutv2=1&subject=' + EMAIL_SUBJECT + '&body=' + EMAIL_BODY + '&to=' + data.representatives_centroid[i].email + ", minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + '&bcc=volunteer@moreneighbours.ca' + '&path=%2fmail%2faction%2fcompose" class="email-header" target="_blank"><img src="assets/img/Outlook-Email.png" class="icon" alt="assets/img/No-Image.png"></a>' +
						'</div>' +
						'<div class="col-xs-2 col-xs-offset-1 justify-content-center text-center">' +
						'<h5><a id="yahoo_text_' + data.representatives_centroid[i].name + '" href="http://compose.mail.yahoo.com/?to=' + data.representatives_centroid[i].email + ", minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + '&bcc=volunteer@moreneighbours.ca' + '&subj=' + EMAIL_SUBJECTYH + '&body=' + EMAIL_BODYYH + '" class="email-header" target="_blank">Yahoo</a></h5>' +
						...
						'</div>' +
						'<div class="col-xs-2 col-xs-offset-1 justify-content-center text-center">' +
						'<h5><a id="other_mail_text_' + data.representatives_centroid[i].name + '" href="mailto:' + data.representatives_centroid[i].email + "; minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org"  + '?subject=' + EMAIL_SUBJECT + '&bcc=volunteer@moreneighbours.ca' +  '&body=' + EMAIL_BODY + '" class="email-header">Other</a></h5>' +
						'<a id="other_mail_icon_' + data.representatives_centroid[i].name + '" href="mailto:' + data.representatives_centroid[i].email + "; minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + '?subject=' + EMAIL_SUBJECT + '&bcc=volunteer@moreneighbours.ca' +  '&body=' + EMAIL_BODY + '"><img src="assets/img/Other-Email.png" class="icon" alt="assets/img/No-Image.png"></a>' +
						'</div>' +
						'</small>' +
						'</br>' +
...
function selectionChanged(obj) {
	...
	for (let i = 0; i < profileObj.representatives_centroid.length; i++) {
		...
		let emailTemplateBody = EMAIL_TEMPLATE_BODY.replace(/USER_NAME_TO_REPLACE/gi, document.getElementById("t_name").value)
									...
									.replace(/POSTAL_CODE_TO_REPLACE/gi, document.getElementById("t_pCode").value)
									.replace(/USER_EMAIL_TO_REPLACE/gi, document.getElementById("t_email").value);
		document.getElementById("gmail_text_" + profileObj.representatives_centroid[i].name).href = "https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=" + profileObj.representatives_centroid[i].email + "; minister.mah@ontario.ca; jbell-co@ndp.on.ca; sblais.mpp.co@liberal.ola.org; mschreiner-co@ola.org" + "&su=" + EMAIL_SUBJECT + "&body=" + EMAIL_BODY;
		...
		document.getElementById("outlook_text_" + profileObj.representatives_centroid[i].name).href = "https://outlook.office.com/mail/0/deeplink/compose?popoutv2=1&subject=" + EMAIL_SUBJECT + "&body=" + EMAIL_BODY + "&to=" + profileObj.representatives_centroid[i].email + ", minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + "&path=%2fmail%2faction%2fcompose";
		document.getElementById("outlook_icon_" + profileObj.representatives_centroid[i].name).href = "https://outlook.office.com/mail/0/deeplink/compose?popoutv2=1&subject=" + EMAIL_SUBJECT + "&body=" + EMAIL_BODY + "&to=" + profileObj.representatives_centroid[i].email + ", minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + "&path=%2fmail%2faction%2fcompose";
		document.getElementById("yahoo_text_" + profileObj.representatives_centroid[i].name).href = "http://compose.mail.yahoo.com/?to=" + profileObj.representatives_centroid[i].email + ", minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + "&subj=" + EMAIL_SUBJECTYH + "&body=" + EMAIL_BODYYH + "%2523";
		document.getElementById("yahoo_icon_" + profileObj.representatives_centroid[i].name).href = "http://compose.mail.yahoo.com/?to=" + profileObj.representatives_centroid[i].email + ", minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + "&subj=" + EMAIL_SUBJECTYH + "&body=" + EMAIL_BODYYH + "%2523";
		document.getElementById("other_mail_text_" + profileObj.representatives_centroid[i].name).href = "mailto:" + profileObj.representatives_centroid[i].email + ", minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + "?subject=" + EMAIL_SUBJECT + "&body=" + EMAIL_BODY;
		document.getElementById("other_mail_icon_" + profileObj.representatives_centroid[i].name).href = "mailto:" + profileObj.representatives_centroid[i].email + ", minister.mah@ontario.ca, jbell-co@ndp.on.ca, sblais.mpp.co@liberal.ola.org, mschreiner-co@ola.org" + "?subject=" + EMAIL_SUBJECT + "&body=" + EMAIL_BODY;
